defmodule FF do
  ...
  In `FF`, a file path is not itself a stream. The graph callback receives an
  ...
  `FF` builds an Elixir command model and translates it to ffmpeg argv. ffmpeg
  ...
  Labels such as `[out0]` are generated by `FF`; they are implementation
